...
//		var changeAdd = imgFile[imgCount].getAttribute('src').toString().replace(pattern, saveImgAdd);
//			$('#textViewDesDiv img')[imgCount].setAttribute('src', changeAdd);
	}
...
//			$('#textViewDesDiv img')[imgCount].setAttribute('src', changeAdd);
	...
	var cancelConfirmMsg = "게시글 작성을 취소하시겠습니까??"
