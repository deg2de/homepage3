...
/**
 * 클래스명(물리) : 출력용 댓글 정보DTO
 * 클래스명(논리) : CommentViewInfoDto.java
 * 
 * 작성자 : 이성복
 * 최초 작성 날짜 : 2020-11-27
 * 마지막 수정 날짜 : 2020-11-27
 */
public class CommentViewInfoDto {
	/** 댓글 정보.댓글 번호 */
	...
	public int getCommentIdFlg() {
		return commentIdFlg;
	}
	public void setCommentIdFlg(int commentIdFlg) {
		this.commentIdFlg = commentIdFlg;
	}
}
